...
class BlueAckermannLowLevelBridge(object):
    ...
    def __init__(self):
        ...
        # wheel_speed_sign is 1.0 because positive wheel speed moves the car
        # forward in the provided simulation. Change steering_angle_sign only if
        # left/right steering is inverted in your Gazebo setup.
        # -------------------------------------------------------------------------
