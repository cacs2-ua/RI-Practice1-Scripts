...
class BlueAckermannLowLevelBridge(object):
    ...
    def __init__(self):
        ...
        # wheel_speed_sign is 1.0 because your direct test moved the car with
        # wheel_speed:=2.0. steering_angle_sign can be changed if turns are inverted.
        # -------------------------------------------------------------------------
        ...
        # These are the real Gazebo controller topics that moved the car in your
        # manual test.
        # -------------------------------------------------------------------------
        ...
        # This makes /blue/ackermann_cmd finally have a subscriber.
        # -------------------------------------------------------------------------
